...
<div class="container">
    <div class="col">
        <div class="row">
            <h3 class="title">Tambah Mitra</h3>
        </div>
        <div class="row">
            @if ($errors->any())
            ...
            <form action="{{ route('daftar-mitra.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="tahun_berdiri" type="text" class="rounded form-control @error('tahun_berdiri') is-invalid @enderror" name="tahun_berdiri" required autofocus>
                        @error('tahun_berdiri')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="jadwal" type="text" class="rounded form-control @error('jadwal') is-invalid @enderror" name="jadwal" required autofocus></textarea>
                        @error('jadwal')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="materi" type="text" class="rounded form-control @error('materi') is-invalid @enderror" name="materi" required autofocus></textarea>
                        @error('materi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="perlengkapan_peserta" type="text" class="rounded form-control @error('perlengkapan_peserta') is-invalid @enderror" name="perlengkapan_peserta" required autofocus></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="fasilitas" type="text" class="rounded form-control @error('fasilitas') is-invalid @enderror" name="fasilitas" required autofocus></textarea>
                        @error('fasilitas')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="keuntungan" type="text" class="rounded form-control @error('keuntungan') is-invalid @enderror" name="keuntungan" required autofocus></textarea>
                        @error('keuntungan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea id="sertifikat" type="text" class="rounded form-control @error('sertifikat') is-invalid @enderror" name="sertifikat" required autofocus></textarea>
                        @error('sertifikat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
